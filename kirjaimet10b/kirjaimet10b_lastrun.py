...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\MyTemp\\psychopy\\kirjaimet10b\\kirjaimet10b_lastrun.py',
...
for thisTrial in trials:
    ...
    mouse.clicked_name = []
    gotValidClick = False  # until a click is received
    v04.setPos((px03,py03))
    v04.setSize((pw,ph))
    v05.setPos((px04,py04))
    v05.setSize((pw,ph))
    v08.setPos((px07,py07))
    v08.setSize((pw,ph))
    v09.setPos((px08,py08))
    v09.setSize((pw,ph))
    v10.setPos((px09,py09))
    v10.setSize((pw,ph))
    v14.setPos((px13,py13))
    v14.setSize((pw,ph))
    v15.setPos((px14,py14))
    v15.setSize((pw,ph))
    v16_oikea.setPos((px15,py15))
    v16_oikea.setSize((pw,ph))
    v19.setPos((px18,py18))
    v19.setSize((pw,ph))
    v20.setPos((px19,py19))
    v20.setSize((pw,ph))
    # keep track of which components have finished
    trialComponents = [mouse, v04, v05, v08, v09, v10, v14, v15, v16_oikea, v19, v20]
    ...
    while continueRoutine:
        ...
        if mouse.status == STARTED:  # only update if started and not finished!
            ...
            if buttons != prevButtonState:  # button state changed?
                ...
                if sum(buttons) > 0:  # state changed to a new click
                    ...
                    gotValidClick = False
                    for obj in [v04,v05,v08,v09,v10,v14,v15,v16_oikea,v19,v20]:
        ...
        # *v16_oikea* updates
        if v16_oikea.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            v16_oikea.frameNStart = frameN  # exact frame index
            v16_oikea.tStart = t  # local t and not account for scr refresh
            v16_oikea.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(v16_oikea, 'tStartRefresh')  # time at next scr refresh
            v16_oikea.setAutoDraw(True)
    ...
    trials.addData('v16_oikea.started', v16_oikea.tStartRefresh)
    trials.addData('v16_oikea.stopped', v16_oikea.tStopRefresh)
