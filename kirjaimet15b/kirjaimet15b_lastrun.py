...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\MyTemp\\psychopy\\kirjaimet15b\\kirjaimet15b_lastrun.py',
...
for thisTrial in trials:
    ...
    v15.setSize((pw,ph))
    v17.setPos((px19,py19))
    v17.setSize((pw,ph))
    v18.setPos((px20,py20))
    v18.setSize((pw,ph))
    v19_oikea.setPos((px01,py01))
    v19_oikea.setSize((pw,ph))
    v20.setPos((px02,py02))
    v20.setSize((pw,ph))
    # keep track of which components have finished
    trialComponents = [mouse, v03, v04, v05, v07, v08, v09, v10, v12, v13, v14, v15, v17, v18, v19_oikea, v20]
    ...
    while continueRoutine:
        ...
        if mouse.status == STARTED:  # only update if started and not finished!
            ...
            if buttons != prevButtonState:  # button state changed?
                ...
                if sum(buttons) > 0:  # state changed to a new click
                    ...
                    gotValidClick = False
                    for obj in [v03,v04,v05,v07,v08,v09,v10,v12,v13,v14,v15,v17,v18,v19_oikea,v20]:
        ...
        # *v19_oikea* updates
        if v19_oikea.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            v19_oikea.frameNStart = frameN  # exact frame index
            v19_oikea.tStart = t  # local t and not account for scr refresh
            v19_oikea.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(v19_oikea, 'tStartRefresh')  # time at next scr refresh
    ...
    trials.addData('v19_oikea.started', v19_oikea.tStartRefresh)
    trials.addData('v19_oikea.stopped', v19_oikea.tStopRefresh)
