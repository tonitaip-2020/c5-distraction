...
let expName = 'kirjaimet20ha';  // from the Builder filename that created this script
...
function experimentInit() {
  ...
  text_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_2',
    text: 'Napsauta kirjainyhdistelmää IJK\ntai painiketta "jatka",\njos kirjainyhdistelmää ei löydy\n\n(napsauta aloittaaksesi)',
    font: 'Arial',
    units : undefined, 
  ...
  v01_oikea = new visual.ImageStim({
    win : psychoJS.window,
...
function trialRoutineBegin() {
  ...
  trialComponents.push(v01_oikea);
...
function trialRoutineEachFrame() {
  ...
  if (mouse.status === PsychoJS.Status.STARTED) {  // only update if started and not finished!
    ...
    if (!buttons.every( (e,i,) => (e == prevButtonState[i]) )) { // button state changed?
      ...
      if (buttons.reduce( (e, acc) => (e+acc) ) > 0) { // state changed to a new click
        ...
        gotValidClick = false;
        for (const obj of [v01_oikea,v02,v03,v04,v05,v06,v07,v08,v09,v10,v11,v12,v13,v14,v15,v16,v17,v18,v19,v20,v21,jatka]) {
  ...
  // *v01_oikea* updates
  if (t >= 0.5 && v01_oikea.status === PsychoJS.Status.NOT_STARTED) {
    // keep track of start time/frame for later
    v01_oikea.tStart = t;  // (not accounting for frame time here)
