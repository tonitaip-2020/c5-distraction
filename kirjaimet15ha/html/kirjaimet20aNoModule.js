...
let expName = 'kirjaimet20a';  // from the Builder filename that created this script
...
function experimentInit() {
  ...
  text_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_2',
    text: 'Napsauta kirjainyhdistelmää LJI\n\n(napsauta aloittaaksesi)',
    font: 'Arial',
    units : undefined, 
  ...
  v01 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'v01', units : 'norm', 
    image : 'ijk.png', mask : undefined,
    ori : 0, pos : [0, 0], size : 1.0,
    color : new util.Color([1, 1, 1]), opacity : 1,
    flipHoriz : false, flipVert : false,
    texRes : 128, interpolate : true, depth : -1.0 
  });
  v02 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'v02', units : undefined, 
    image : 'ijl.png', mask : undefined,
    ori : 0, pos : [0, 0], size : 1.0,
    color : new util.Color([1, 1, 1]), opacity : 1,
    flipHoriz : false, flipVert : false,
  ...
  v06 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'v06', units : undefined, 
    image : 'jik.png', mask : undefined,
    ori : 0, pos : [0, 0], size : 1.0,
    color : new util.Color([1, 1, 1]), opacity : 1,
    flipHoriz : false, flipVert : false,
  ...
  v11 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'v11', units : undefined, 
    image : 'kij.png', mask : undefined,
    ori : 0, pos : [0, 0], size : 1.0,
    color : new util.Color([1, 1, 1]), opacity : 1,
    flipHoriz : false, flipVert : false,
  ...
  v16 = new visual.ImageStim({
    win : psychoJS.window,
    name : 'v16', units : undefined, 
    image : 'lij.png', mask : undefined,
    ori : 0, pos : [0, 0], size : 1.0,
    color : new util.Color([1, 1, 1]), opacity : 1,
    flipHoriz : false, flipVert : false,
  ...
  v18_oikea = new visual.ImageStim({
    win : psychoJS.window,
    name : 'v18_oikea', units : undefined, 
...
function trialRoutineBegin() {
  ...
  v17.setSize([pw, ph]);
  v18_oikea.setPos([px18, py18]);
  v18_oikea.setSize([pw, ph]);
...
function trialRoutineEachFrame() {
  ...
  if (mouse.status === PsychoJS.Status.STARTED) {  // only update if started and not finished!
    ...
    if (!buttons.every( (e,i,) => (e == prevButtonState[i]) )) { // button state changed?
      ...
      if (buttons.reduce( (e, acc) => (e+acc) ) > 0) { // state changed to a new click
        ...
        gotValidClick = false;
        for (const obj of [v01,v02,v03,v04,v05,v06,v07,v08,v09,v10,v11,v12,v13,v14,v15,v16,v17,v18_oikea,v19,v20]) {
  ...
  // *v01* updates
  if (t >= 0.5 && v01.status === PsychoJS.Status.NOT_STARTED) {
    // keep track of start time/frame for later
    v01.tStart = t;  // (not accounting for frame time here)
    v01.frameNStart = frameN;  // exact frame index
    v01.setAutoDraw(true);
  }

  
  // *v02* updates
  if (t >= 0.5 && v02.status === PsychoJS.Status.NOT_STARTED) {
    // keep track of start time/frame for later
    v02.tStart = t;  // (not accounting for frame time here)
  ...
  // *v06* updates
  if (t >= 0.5 && v06.status === PsychoJS.Status.NOT_STARTED) {
    // keep track of start time/frame for later
    v06.tStart = t;  // (not accounting for frame time here)
  ...
  // *v11* updates
  if (t >= 0.5 && v11.status === PsychoJS.Status.NOT_STARTED) {
    // keep track of start time/frame for later
    v11.tStart = t;  // (not accounting for frame time here)
  ...
  // *v16* updates
  if (t >= 0.5 && v16.status === PsychoJS.Status.NOT_STARTED) {
    // keep track of start time/frame for later
    v16.tStart = t;  // (not accounting for frame time here)
  ...
  // *v18_oikea* updates
  if (t >= 0.5 && v18_oikea.status === PsychoJS.Status.NOT_STARTED) {
    // keep track of start time/frame for later
    v18_oikea.tStart = t;  // (not accounting for frame time here)
    v18_oikea.frameNStart = frameN;  // exact frame index
    v18_oikea.setAutoDraw(true);
  }
...
function clicktocontinueRoutineBegin() {
  ...
  clicktocontinueComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
