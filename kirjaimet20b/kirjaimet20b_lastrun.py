...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\MyTemp\\psychopy\\kirjaimet20b\\kirjaimet20b_lastrun.py',
...
for thisTrial in trials:
    ...
    mouse.clicked_name = []
    gotValidClick = False  # until a click is received
    v01.setPos((px02,py02))
    v01.setSize((pw,ph))
    v02.setPos((px03,py03))
    v02.setSize((pw,ph))
    v03.setPos((px04,py04))
    v03.setSize((pw,ph))
    v04.setPos((px05,py05))
    v04.setSize((pw,ph))
    v05.setPos((px06,py06))
    v05.setSize((pw,ph))
    v06.setPos((px07,py07))
    v06.setSize((pw,ph))
    v07.setPos((px08,py08))
    v07.setSize((pw,ph))
    v08.setPos((px09,py09))
    v08.setSize((pw,ph))
    v09.setPos((px10,py10))
    v09.setSize((pw,ph))
    v10.setPos((px11,py11))
    v10.setSize((pw,ph))
    v11.setPos((px12,py12))
    v11.setSize((pw,ph))
    v12.setPos((px13,py13))
    v12.setSize((pw,ph))
    v13.setPos((px14,py14))
    v13.setSize((pw,ph))
    v14.setPos((px15,py15))
    v14.setSize((pw,ph))
    v15.setPos((px16,py16))
    v15.setSize((pw,ph))
    v16.setPos((px17,py17))
    v16.setSize((pw,ph))
    v17.setPos((px18,py18))
    v17.setSize((pw,ph))
    v18_oikea.setPos((px19,py19))
    v18_oikea.setSize((pw,ph))
    v19.setPos((px20,py20))
    v19.setSize((pw,ph))
    v20.setPos((px01,py01))
    v20.setSize((pw,ph))
    # keep track of which components have finished
    trialComponents = [mouse, v01, v02, v03, v04, v05, v06, v07, v08, v09, v10, v11, v12, v13, v14, v15, v16, v17, v18_oikea, v19, v20]
    ...
    while continueRoutine:
        ...
        if mouse.status == STARTED:  # only update if started and not finished!
            ...
            if buttons != prevButtonState:  # button state changed?
                ...
                if sum(buttons) > 0:  # state changed to a new click
                    ...
                    gotValidClick = False
                    for obj in [v01,v02,v03,v04,v05,v06,v07,v08,v09,v10,v11,v12,v13,v14,v15,v16,v17,v18_oikea,v19,v20]:
        ...
        # *v01* updates
        if v01.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            v01.frameNStart = frameN  # exact frame index
            v01.tStart = t  # local t and not account for scr refresh
            v01.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(v01, 'tStartRefresh')  # time at next scr refresh
        ...
        # *v18_oikea* updates
        if v18_oikea.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            v18_oikea.frameNStart = frameN  # exact frame index
            v18_oikea.tStart = t  # local t and not account for scr refresh
            v18_oikea.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(v18_oikea, 'tStartRefresh')  # time at next scr refresh
    ...
    trials.addData('v01.started', v01.tStartRefresh)
    trials.addData('v01.stopped', v01.tStopRefresh)
    ...
    trials.addData('v18_oikea.started', v18_oikea.tStartRefresh)
    trials.addData('v18_oikea.stopped', v18_oikea.tStopRefresh)
