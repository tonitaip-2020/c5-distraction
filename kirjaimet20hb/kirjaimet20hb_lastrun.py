...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\MyTemp\\psychopy\\kirjaimet20hb\\kirjaimet20hb_lastrun.py',
...
for thisTrial in trials:
    ...
    mouse.clicked_name = []
    gotValidClick = False  # until a click is received
    v01_oikea.setPos((px04,py04))
    v01_oikea.setSize((pw,ph))
    v02.setPos((px05,py05))
    v02.setSize((pw,ph))
    v03.setPos((px06,py06))
    v03.setSize((pw,ph))
    v04.setPos((px07,py07))
    v04.setSize((pw,ph))
    v05.setPos((px08,py08))
    v05.setSize((pw,ph))
    v06.setPos((px09,py09))
    v06.setSize((pw,ph))
    v07.setPos((px10,py10))
    v07.setSize((pw,ph))
    ...
    v10.setSize((pw,ph))
    v11.setPos((px14,py14))
    v11.setSize((pw,ph))
    v12.setPos((px15,py15))
    v12.setSize((pw,ph))
    ...
    v15.setSize((pw,ph))
    v16.setPos((px19,py19))
    v16.setSize((pw,ph))
    v17.setPos((px20,py20))
    v17.setSize((pw,ph))
    v18.setPos((px01,py01))
    v18.setSize((pw,ph))
    v19.setPos((px02,py02))
    v19.setSize((pw,ph))
    v20.setPos((px03,py03))
    v20.setSize((pw,ph))
