...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\MyTemp\\psychopy\\kirjaimet15hb\\kirjaimet15hb_lastrun.py',
...
for thisTrial in trials:
    ...
    mouse.clicked_name = []
    gotValidClick = False  # until a click is received
    v02_oikea.setPos((px04,py04))
    v02_oikea.setSize((pw,ph))
    v03.setPos((px05,py05))
    v03.setSize((pw,ph))
    v04.setPos((px06,py06))
    v04.setSize((pw,ph))
    v05.setPos((px07,py07))
    v05.setSize((pw,ph))
    v07.setPos((px09,py09))
    v07.setSize((pw,ph))
    v08.setPos((px10,py10))
    v08.setSize((pw,ph))
    v09.setPos((px11,py11))
    v09.setSize((pw,ph))
    v10.setPos((px12,py12))
    v10.setSize((pw,ph))
    v12.setPos((px14,py14))
    v12.setSize((pw,ph))
    v13.setPos((px15,py15))
    v13.setSize((pw,ph))
    v14.setPos((px16,py16))
    v14.setSize((pw,ph))
    v15.setPos((px17,py17))
    v15.setSize((pw,ph))
    v18.setPos((px20,py20))
    v18.setSize((pw,ph))
    v19.setPos((px01,py01))
    v19.setSize((pw,ph))
    v20.setPos((px02,py02))
    v20.setSize((pw,ph))
    ...
    jatka.setSize((jw,jh))
    # keep track of which components have finished
    trialComponents = [mouse, v02_oikea, v03, v04, v05, v07, v08, v09, v10, v12, v13, v14, v15, v18, v19, v20, v21, jatka]
    ...
    while continueRoutine:
        ...
        if mouse.status == STARTED:  # only update if started and not finished!
            ...
            if buttons != prevButtonState:  # button state changed?
                ...
                if sum(buttons) > 0:  # state changed to a new click
                    ...
                    gotValidClick = False
                    for obj in [v02_oikea,v03,v04,v05,v07,v08,v09,v10,v12,v13,v14,v15,v18,v19,v20,v21,jatka]:
        ...
        # *v02_oikea* updates
        if v02_oikea.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
            # keep track of start time/frame for later
            v02_oikea.frameNStart = frameN  # exact frame index
            v02_oikea.tStart = t  # local t and not account for scr refresh
            v02_oikea.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(v02_oikea, 'tStartRefresh')  # time at next scr refresh
            v02_oikea.setAutoDraw(True)
    ...
    trials.addData('v02_oikea.started', v02_oikea.tStartRefresh)
    trials.addData('v02_oikea.stopped', v02_oikea.tStopRefresh)
